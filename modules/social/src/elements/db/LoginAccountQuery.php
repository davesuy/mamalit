...
namespace modules\social\elements\db;
...
class LoginAccountQuery extends ElementQuery
{
    ...
    {
        $this->joinElementTable('depotise_social_login_accounts');
        $this->query->leftJoin('{{%users}} users', '[[depotise_social_login_accounts.userId]] = [[users.id]]');
        $this->subQuery->leftJoin('{{%users}} users', '[[depotise_social_login_accounts.userId]] = [[users.id]]');

        $this->subQuery->leftJoin('{{%elements}} elements_users', '[[depotise_social_login_accounts.userId]] = [[elements_users.id]]');

        $this->query->select([
            'depotise_social_login_accounts.userId',
            'depotise_social_login_accounts.providerHandle',
            'depotise_social_login_accounts.socialUid',
        ]);

        $this->addWhere('userId', 'depotise_social_login_accounts.userId');
        $this->addWhere('providerHandle', 'depotise_social_login_accounts.providerHandle');
        $this->addWhere('socialUid', 'depotise_social_login_accounts.socialUid');
