...
namespace modules\depotisemodule\gateways;
...
class Paymongo extends Gateway
{
	...
	{
		return Craft::t('depotise-module', 'Paymongo');
	}
	...
	public function getPaymentFormHtml(array $params)
	{
		...
		{
			$paymentFormModel->firstName = '';
			$paymentFormModel->lastName = '';
			$paymentFormModel->number = '';
			$paymentFormModel->expiry = '';
			$paymentFormModel->cvv = '';
		}
	...
	{
		return Craft::$app->getView()->renderTemplate('depotise-module/gateways/paymongo-settings', ['gateway' => $this]);
	}
	...
	{
		return [
			'purchase' => 'Purchase (Authorize and Capture Immediately)'
		];
	}
